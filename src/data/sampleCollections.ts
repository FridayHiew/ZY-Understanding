...
export const SAMPLE_COLLECTIONS: KnowledgeCollection[] = [
  ...
  // ============================================================
  {
    ...
    passage: '清明节是中华民族的传统节日，通常在每年公历的四月四日或五日。清明节既是扫墓祭祖的肃穆节日，也是人们亲近自然、踏青游玩、享受春光之乐的节日。在这一天，人们会扶老携幼来到祖先的墓前，铲除杂草，献上鲜花与供品，表达对先人的怀念与敬意。除了扫墓，清明节还有吃青团、放风筝、插柳等丰富多彩的传统习俗。青团是用艾草汁拌入糯米粉制成的，吃起来香甜可口，带有淡淡 of 草木清香。',
    group: '华文',
    difficulty: '四年级',
